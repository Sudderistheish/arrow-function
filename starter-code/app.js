...
// When joe.scope() is invoked, within the regular function scope(), the value of this refers to the joe object.
// Regular functions in JavaScript establish their own this context based on how they are called, and
// in this case, this inside the scope() function refers to the instance of the Student object created as 'joe'.
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked, within the arrow function scopeArrow(), the value of this refers to the outermost scope, which is likely the global scope. In a browser environment, this would typically be the window object.
// Arrow functions do not have their own this context; instead, they inherit the this value from the surrounding code.
//
// 3. Explain why "this" is different when an arrow function is used.
// The difference in how this behaves in regular functions and arrow functions stems from how they handle their execution context.
// In regular functions, the value of this is dynamically determined based on how the function is called. In contrast, arrow functions inherit this from their containing scope, and they do not create their own this context. This makes arrow functions particularly useful for cases where you want to maintain the surrounding context's this value, like in the context of callbacks or when dealing with closures.
// However, this also means that arrow functions are not suitable for methods that need access to their own instance-specific context, like prototype methods of constructor functions, as seen in your joe.scopeArrow()
//
//
